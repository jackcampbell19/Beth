...
class Arm:
    ...
    def set_position(self, v):
        ...
        self.x_stepper.motor_go(clockwise=True if steps[0] > 0 else False, steps=abs(steps[0]), stepdelay=0.005)
        self.y_stepper.motor_go(clockwise=True if steps[1] > 0 else False, steps=abs(steps[1]), stepdelay=0.005)
